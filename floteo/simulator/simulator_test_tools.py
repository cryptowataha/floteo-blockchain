...
from floteo.cmds.init_funcs import create_all_ssl
...
async def get_full_chia_simulator(
    ...
    """
    A floteo root directory can be provided, otherwise a temporary one is created.
    This test can either be run in automated mode or not, which determines which mode block tools run in.
    This test is fully interdependent and can be used without the rest of the floteo test suite.
    Please refer to the documentation for more information.
    """
    # Create and setup temporary floteo directories.
