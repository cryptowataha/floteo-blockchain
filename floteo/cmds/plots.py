...
from floteo.plotting.util import add_plot_directory, validate_plot_size
...
def show_plots(root_path: Path):
    from floteo.plotting.util import get_plot_directories
...
def create_cmd(
    ...
    from floteo.plotting.create_plots import create_plots, resolve_plot_keys
...
def check_cmd(
    ...
    from floteo.plotting.check_plots import check_plots
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from floteo.plotting.util import remove_plot_directory
