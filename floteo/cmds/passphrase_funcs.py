...
from floteo.daemon.client import acquire_connection_to_daemon
from floteo.util.config import load_config
from floteo.util.errors import KeychainMaxUnlockAttempts
from floteo.util.keychain import Keychain, supports_os_passphrase_storage
from floteo.util.keyring_wrapper import KeyringWrapper, DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'floteo passphrase set' or 'floteo passphrase remove' to update or remove your passphrase")
        sys.exit(1)
