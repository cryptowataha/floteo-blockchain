...
from floteo.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet10.floteo.net"
                testnet_dns_introducer = "dns-introducer-testnet10.floteo.net"
                bootstrap_peers = ["testnet10-node.floteo.net"]
                testnet = "testnet10"
                ...
                mainnet_port = "8444"
                mainnet_introducer = "introducer.floteo.net"
                mainnet_dns_introducer = "dns-introducer.floteo.net"
                bootstrap_peers = ["node.floteo.net"]
                net = "mainnet"
