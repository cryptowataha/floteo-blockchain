...
from floteo.cmds.keys_funcs import migrate_keys
from floteo.cmds.passphrase_funcs import get_current_passphrase
...
from floteo.util.service_groups import services_for_groups
...
async def async_start(
    ...
    if daemon is None:
        print("Failed to create the floteo daemon")
        return None
