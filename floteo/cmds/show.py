...
from floteo.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'floteo show -c' has been renamed to 'floteo peer -c' ")
    if add_connection != "":
        print("'floteo show -a' has been renamed to 'floteo peer -a' ")
    if remove_connection != "":
        print("'floteo show -r' has been renamed to 'floteo peer -r' ")
    if wallet_rpc_port is not None:
        print("'floteo show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
