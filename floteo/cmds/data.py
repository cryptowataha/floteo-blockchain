...
def create_data_store(
    ...
    from floteo.cmds.data_funcs import create_data_store_cmd
...
def get_value(
    ...
    from floteo.cmds.data_funcs import get_value_cmd
...
def update_data_store(
    ...
    from floteo.cmds.data_funcs import update_data_store_cmd
...
def get_keys(
    ...
    from floteo.cmds.data_funcs import get_keys_cmd
...
def get_keys_values(
    ...
    from floteo.cmds.data_funcs import get_keys_values_cmd
...
def get_root(
    ...
    from floteo.cmds.data_funcs import get_root_cmd
...
def subscribe(
    ...
    from floteo.cmds.data_funcs import subscribe_cmd
...
def remove_subscription(
    ...
    from floteo.cmds.data_funcs import remove_subscriptions_cmd
...
def unsubscribe(
    ...
    from floteo.cmds.data_funcs import unsubscribe_cmd
...
def get_kv_diff(
    ...
    from floteo.cmds.data_funcs import get_kv_diff_cmd
...
def get_root_history(
    ...
    from floteo.cmds.data_funcs import get_root_history_cmd
...
def add_missing_files(ids: Optional[str], overwrite: bool, foldername: Optional[str], data_rpc_port: int) -> None:
    from floteo.cmds.data_funcs import add_missing_files_cmd
...
def add_mirror(id: str, amount: int, urls: List[str], fee: Optional[str], data_rpc_port: int) -> None:
    from floteo.cmds.data_funcs import add_mirror_cmd
...
def delete_mirror(coin_id: str, fee: Optional[str], data_rpc_port: int) -> None:
    from floteo.cmds.data_funcs import delete_mirror_cmd
...
def get_mirrors(id: str, data_rpc_port: int) -> None:
    from floteo.cmds.data_funcs import get_mirrors_cmd
...
def get_subscriptions(data_rpc_port: int) -> None:
    from floteo.cmds.data_funcs import get_subscriptions_cmd
...
def get_owned_stores(data_rpc_port: int) -> None:
    from floteo.cmds.data_funcs import get_owned_stores_cmd
