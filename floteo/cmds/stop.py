...
from floteo.util.service_groups import all_groups, services_for_groups
...
async def async_stop(root_path: Path, config: Dict[str, Any], group: str, stop_daemon: bool) -> int:
    ...
    if daemon is None:
        print("Couldn't connect to floteo daemon")
        return 1
...
def stop_cmd(ctx: click.Context, daemon: bool, group: str) -> None:
    from floteo.cmds.beta_funcs import warn_if_beta_enabled
