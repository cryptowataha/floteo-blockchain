...
from floteo.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from floteo.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from floteo.pools.pool_puzzles import (
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `floteo singleton` that is
