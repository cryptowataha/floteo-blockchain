...
from floteo.daemon.server import service_launch_lock_path
...
from floteo.rpc.rpc_server import RpcApiProtocol, RpcServiceProtocol, start_rpc_server, RpcServer
from floteo.server.outbound_message import NodeType
from floteo.server.server import ChiaServer
from floteo.server.upnp import UPnP
...
class Service(Generic[_T_RpcServiceProtocol]):
    def __init__(
        ...
        *,
        ...
        self._log.info(f"floteo-blockchain version: {chia_full_version_str()}")
