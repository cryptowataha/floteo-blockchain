...
try:
    ...
    log.info(
        ...
        " This is not required to run floteo, it allows incoming connections from other peers."
    )
    miniupnpc = None
        ...
        try:
            ...
            while keep_going:
                ...
                if msg[0] == "remap":
                    ...
                    self._upnp.addportmapping(port, "TCP", self._upnp.lanaddr, port, "floteo", "")
                    log.info(
            ...
            log.info("UPnP failed. This is not required to run floteo, it allows incoming connections from other peers.")
            log.info(e)
