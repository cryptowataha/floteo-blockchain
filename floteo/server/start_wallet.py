...
from floteo.util.config import load_config_cli, load_config
...
from floteo.wallet.wallet_node_api import WalletNodeAPI
...
def main() -> int:
    ...
    if os.getenv("CHIA_INSTRUMENT_WALLET", 0) != 0:
        from floteo.util.task_timing import start_task_instrumentation, stop_task_instrumentation
        import atexit
