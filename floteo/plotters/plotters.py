...
from floteo.plotters.bladebit import get_bladebit_install_info, plot_bladebit
from floteo.plotters.chiapos import get_chiapos_install_info, plot_chia
from floteo.plotters.madmax import get_madmax_install_info, plot_madmax
...
def call_plotters(root_path: Path, args):
    ...
    plotters = argparse.ArgumentParser("floteo plotters", description="Available options.")
    ...
    deprecation_warning = (
        "[DEPRECATED] 'floteo plotters install' is no longer available. Use install-plotter.sh/ps1 instead."
    )
