...
from floteo.plot_sync.delta import Delta
from floteo.plot_sync.receiver import Receiver
from floteo.pools.pool_config import PoolWalletConfig, add_auth_key, load_pool_config
from floteo.protocols import farmer_protocol, harvester_protocol
from floteo.protocols.pool_protocol import (
...
from floteo.server.server import ssl_context_for_root
...
from floteo.util.bech32m import decode_puzzle_hash
from floteo.util.byte_types import hexstr_to_bytes
from floteo.util.config import config_path_for_filename, load_config, lock_and_load_config, save_config
from floteo.util.errors import KeychainProxyConnectionFailure
...
from floteo.wallet.puzzles.singleton_top_layer import SINGLETON_MOD
...
class Farmer:
    ...
    async def setup_keys(self) -> bool:
        no_keys_error_str = "No keys exist. Please run 'floteo keys generate' or open the UI."
        try:
