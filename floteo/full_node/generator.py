...
from floteo.types.generator_types import BlockGenerator, GeneratorBlockCacheInterface, CompressorArg
from floteo.util.ints import uint32
from floteo.wallet.puzzles.load_clvm import load_clvm_maybe_recompile
from floteo.wallet.puzzles.rom_bootstrap_generator import get_generator

GENERATOR_MOD = get_generator()

DECOMPRESS_BLOCK = load_clvm_maybe_recompile("block_program_zero.clvm", package_or_requirement="floteo.wallet.puzzles")
DECOMPRESS_PUZZLE = load_clvm_maybe_recompile("decompress_puzzle.clvm", package_or_requirement="floteo.wallet.puzzles")
# DECOMPRESS_CSE = load_clvm_maybe_recompile(
#     "decompress_coin_spend_entry.clvm",
#     package_or_requirement="floteo.wallet.puzzles",
# )
