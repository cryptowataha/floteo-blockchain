...
from floteo.rpc.util import wrap_http_handler
from floteo.server.outbound_message import NodeType
from floteo.server.server import ChiaServer, ssl_context_for_client, ssl_context_for_server
...
from floteo.util.config import str2bool
...
from floteo.util.ws_message import WsRpcMessage, create_payload, create_payload_dict, format_response, pong
...
class RpcServiceProtocol(Protocol):
    ...
    def get_connections(self, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
        ...
        floteo.rpc.rpc_server.default_get_connections()
        """
        ...
