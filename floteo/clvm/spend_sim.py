...
from floteo.consensus.coinbase import create_pool_coin, create_farmer_coin
...
There is also a provided NodeClient object which implements many of the methods from floteo.rpc.full_node_rpc_client
