...
from floteo.cmds.init_funcs import check_keys
from floteo.daemon.client import DaemonProxy
from floteo.daemon.keychain_server import (
...
from floteo.util.errors import (
    KeychainIsLocked,
    KeychainIsEmpty,
    KeychainKeyNotFound,
