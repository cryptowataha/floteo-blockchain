...
from floteo.wallet.wallet_node import WalletNode, get_wallet_db_path
...
def test_get_wallet_db_path_v2_r1() -> None:
    root_path: Path = Path("/x/y/z/.floteo/mainnet").resolve()
    config: Dict[str, Any] = {
...
def test_get_wallet_db_path_testnet() -> None:
    root_path: Path = Path("/x/y/z/.floteo/testnet").resolve()
    config: Dict[str, Any] = {
        "database_path": "wallet/db/blockchain_wallet_v2_CHALLENGE_KEY.sqlite",
