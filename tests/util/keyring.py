...
from floteo.util.file_keyring import FileKeyring, keyring_path_from_root
from floteo.util.keychain import Keychain, default_keychain_service, default_keychain_user, get_private_key_user
...
class TempKeyring:
    def __init__(
        ...
        *,
        ...
        service: str = "testing-floteo-1.8.0",
        populate: bool = False,
    ...
    def _patch_and_create_keychain(
        ...
        *,
        ...
        mock_supports_os_passphrase_storage_patch = patch("floteo.util.keychain.supports_os_passphrase_storage")
