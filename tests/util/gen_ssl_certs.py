...
from floteo.ssl.create_ssl import generate_ca_signed_cert, get_chia_ca_crt_key, make_ca_cert
...
def gen_ssl(suffix: str = "") -> None:
    ...
    patch = MonkeyPatch()
    patch.setattr("floteo.ssl.create_ssl.write_ssl_cert_and_key", patched_write_ssl_cert_and_key)
