...
from floteo.data_layer.data_layer_util import NodeType, Status
...
def chia_daemon_fixture(chia_root: ChiaRoot) -> Iterator[None]:
    with closing_chia_root_popen(chia_root=chia_root, args=[sys.executable, "-m", "floteo.daemon.server"]):
