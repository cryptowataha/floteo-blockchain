...
async def test_update_pool_config_new_config(monkeypatch: Any) -> None:
    ...
    monkeypatch.setattr("floteo.pools.pool_wallet.load_pool_config", mock_load_pool_config)
    ...
    monkeypatch.setattr("floteo.pools.pool_wallet.update_pool_config", mock_pool_config_update_pool_config)
