...
from floteo.wallet.puzzles.p2_conditions import puzzle_for_conditions
from floteo.wallet.puzzles import singleton_top_layer
from floteo.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - floteo.pools.pool_puzzles.py
    - floteo.wallet.puzzles.pool_member_innerpuz.clvm
    - floteo.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
