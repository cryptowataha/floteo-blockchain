...
required to run a [Timelord](https://github.com/Chia-Network/floteo-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Chia-Network/floteo-blockchain/blob/main/install-timelord.sh)
